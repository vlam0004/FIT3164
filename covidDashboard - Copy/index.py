...
from app import app
from apps import dashboard, contact_tracing_graphs
...
dropdown = dbc.DropdownMenu(
    children=[
        ...
        dbc.DropdownMenuItem("Contact tracing Line Chart", href="/apps/contact_tracing_graphs"),
    ],
    nav=True,
    in_navbar=True,
    label="Explore",
    ...
    dbc.Container(
        [
            html.A(
                ...
                dbc.Row(
                    [
                        dbc.Col(html.Img(src="/assets/virus.jpg", height="30px")),
